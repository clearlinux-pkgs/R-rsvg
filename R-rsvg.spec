...
Version  : 2.3.0
Release  : 38
URL      : https://cran.r-project.org/src/contrib/rsvg_2.3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rsvg_2.3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650043289
