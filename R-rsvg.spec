...
Version  : 2.3.1
Release  : 42
URL      : https://cran.r-project.org/src/contrib/rsvg_2.3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rsvg_2.3.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650558139
